...
class AirPurifierAccessory extends BaseAccessory {
    ...
    constructor(...props) {
		...
		this.log.warn("stops: %s", this._rotation_stops);
		// this.log.warn("steps: %s", fanSpeedSteps);
		// this.log.warn("speed: %s", _fanSpeedLabels);
    ...
    convertRotationSpeedFromHomeKitToTuya(value) {
     ...
     convertRotationSpeedFromTuyaToHomeKit(value) {
         this.log.warn('convertRotationSpeedFromTuyaToHomeKit: %s: %s', value, this._rotationStops);
         this.log.warn("device: %s", this.device.context);
         this.log.debug('convertRotationSpeedFromTuyaToHomeKit: %s: %s', value, this._rotationStops);
